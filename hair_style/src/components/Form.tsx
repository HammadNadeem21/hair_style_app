    ...
    <div className='py-2 px-2 flex flex-col justify-start items-start gap-4'>
      <div className='flex items-center justify-center gap-3 mt-1 mb-1'>
        ...
        <div className='flex items-center justify-start gap-1'>
          <button
            className={`py-1 px-3 rounded-lg ${hairLength === "long" ? 'bg-blue-500 text-white' : 'bg-[#bfdbfe] text-black'
              }`}
            onClick={() => setHairLength("long")}
          >
            Long
          ...
          <button
            className={`py-1 px-3 rounded-lg ${hairLength === "short" ? 'bg-blue-500 text-white' : 'bg-[#bfdbfe] text-black'
              }`}
            onClick={() => setHairLength("short")}
          >
            Short
      ...
      <div className='flex items-center justify-center gap-3 mt-1 mb-1'>
        ...
        <div className='flex items-center justify-start gap-1'>
          <button
            className={`py-1 px-3 rounded-lg ${hairStyle === "asian" ? 'bg-blue-500 text-white' : 'bg-[#bfdbfe] text-black'
              }`}
          ...
          <button
            className={`py-1 px-3 rounded-lg ${hairStyle === "western" ? 'bg-blue-500 text-white' : 'bg-[#bfdbfe] text-black'
              }`}
